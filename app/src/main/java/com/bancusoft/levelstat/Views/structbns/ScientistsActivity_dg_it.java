...
import com.bancusoft.levelstat.Helpers.structbns.MyAdapter_dg_it;
...
////     */
    ...
    // This java code in Android Studio project
    //Modify this code, this code is deprecated
    //Overrides deprecated method in 'androidx.activity.ComponentActivity'
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                Intent intent = new Intent(ScientistsActivity_dg_it.this, structurabns.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                finish();
                startActivity(intent);
            }
