...
import com.bancusoft.levelstat.Helpers.structbns.MyAdapter_dg_registre;
...
public class ScientistsActivity_dg_registre  extends AppCompatActivity
    ...
    private void retrieveAndFillRecyclerView(final String action,
        ...
        String queryString = "registre si clasificatoare";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                Intent intent = new Intent(ScientistsActivity_dg_registre.this, structurabns.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                finish();
                startActivity(intent);
            }
